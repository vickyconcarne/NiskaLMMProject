...
//----------------------------------------------
Shader "Kirnu/Marvelous/CustomLightingMasterLWRP" {
	...
	SubShader {
		...
		Tags { "LIGHTMODE"="ForwardBase" "QUEUE"="Geometry" "RenderType"="Opaque" "LightMode" = "LightweightForward"}
			HLSLPROGRAM
				...
				#pragma shader_feature USE_DIST_LIGHT_MULTI
				...
				uniform half _LightPositionsCount;
				...
				half4 frag(CL_OUT_WPOS v) : COLOR {
					half4 o = half4(1,1,1,1);
						...
						#else
							half4 c = customLightingSoftFogFrag(v, _FogColor, _FogHeight, _LightTint, _UseLightMap, _LightmapPower, _LightmapColor, _ShadowPower);
